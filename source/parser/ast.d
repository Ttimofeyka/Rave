...
import parser.nodes.constants, parser.nodes.structure;
...
class NodeTypeof : Node {
    ...
    override LLVMValueRef generate() {
        ...
        else if(NodeString str = expr.instanceof!NodeString) {
            t = new TypePointer((str.isWide ? new TypeBasic("uint") : new TypeBasic("char")));
        }
        return null;
    }
}
