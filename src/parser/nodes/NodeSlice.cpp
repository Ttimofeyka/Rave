...
RaveValue NodeSlice::generate() {
    ...
    if (!instanceof<NodeInt>(start) || !instanceof<NodeInt>(end)) {
        ...
        NodeFor* _for = new NodeFor(
            {
                new NodeVar("__RAVE_NODESLICE_I", new NodeDone(lStart), false, false, false, {}, loc, basicTypes[BasicType::Int], false, false, false),
                new NodeVar("__RAVE_NODESLICE_J", new NodeInt(0), false, false, false, {}, loc, basicTypes[BasicType::Int], false, false, false)
            },
